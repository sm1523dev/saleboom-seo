...
export const websites = pgTable(
  "websites",
  {
    ...
    platformHintStatus: text("platform_hint_status").notNull().default("unconfirmed"),
    wrongDetectionCount: integer("wrong_detection_count").notNull().default(0),
    ...timestamps,
  },
...
export const scans = pgTable(
  "scans",
  {
    ...
    seoCompletedAt: timestamp("seo_completed_at", { withTimezone: true }),
    aeoCompletedAt: timestamp("aeo_completed_at", { withTimezone: true }),
    aiTriggeredAt: timestamp("ai_triggered_at", { withTimezone: true }),
    aeoExpected: boolean("aeo_expected").notNull().default(false),
    ...timestamps,
  },
